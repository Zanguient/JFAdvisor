...
#property description "Indicador baseado em RB-ODOMETRO-V2"
...
//--- indicator buffers mapping
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "RB-HT-D (" + IntegerToString(filtro) + ")");

   DivHandle = iCustom(_Symbol, _Period, "estudo\\Rubro-Negro\\RB-ODOMETRO-V2", filtro);
